...
<body>
    <div class="shell">
        ...
        <main class="main">
            <div class="page-head">
                <span class="eyebrow">Kho hàng &middot; Thêm mới</span>
                ...
                <div class="form-panel">
                    <form action="${pageContext.request.contextPath}/admin/product/insert" method="post" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            ...
                            <input type="number" placeholder="0" name="price" step="any" required />
                        </div>
                        ...
                        <div class="field">
                            <label>Ảnh sản phẩm (Link URL hoặc Tải tệp):</label>
                            <input type="text" placeholder="Hoặc dán Link ảnh vào đây" name="image" style="margin-bottom: 10px;" />
                            <div class="file-drop">
