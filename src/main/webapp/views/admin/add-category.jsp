...
<!DOCTYPE html>
<html lang="vi">
<!-- (Phần <head> và CSS giữ nguyên 100% giao diện Earthy Beige cũ của bạn) -->
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .form-panel input[type="text"]:focus { border-color: var(--moss); box-shadow: 0 0 0 3px var(--moss-tint); outline: none; }
        ...
        <main class="main">
            ...
            <div class="form-wrap">
                <div class="form-panel">
                    <!-- URL CHUẨN XÁC ĐẾN CONTROLLER INSERT -->
                    <form role="form" action="${pageContext.request.contextPath}/admin/category/insert" method="post" enctype="multipart/form-data">
                        ...
                        <div class="field">
                            <label>Ảnh đại diện (Tải lên hoặc nhập Link URL):</label>
                            <input type="text" placeholder="Nhập link ảnh (Nếu không tải file)" name="images" style="margin-bottom: 10px;" />
                            <div class="file-drop">
                                <input type="file" name="images1" />
                                <div class="hint">Chọn ảnh minh hoạ cho danh mục.</div>
                            </div>
                        </div>
