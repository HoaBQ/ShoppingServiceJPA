...
<head>
    ...
    <style>
        :root {
            /* Nhóm màu nền (Beige Tones - Dịu mắt) */
            --paper: #EFEAE2;         
            --paper-raised: #FCFAF5;  
            /* Nhóm màu viền & Chữ (Ink & Lines) */
            --ink: #26241F;           
            --ink-soft: #6A6458;      
            --line: #D8D3C8;          
            --line-strong: #C4BEB1;   
            /* Nhóm màu Xanh Rêu chủ đạo (Moss) */
            --moss: #2B4C3F;
            --moss-deep: #1D362D;
            --moss-tint: #E1E8E3;
            /* Nhóm màu Nhấn (Accent Tones) */
            --rust: #C1531B;
            --rust-tint: #F5E3D6;
            --gold: #C59B27;
            --gold-tint: #FDF8E7;
        ...
        * { box-sizing: border-box; }
        ...
        .check-row input { accent-color: var(--moss); }
        .btn-primary {
            display: block;
            width: 100%;
            font-family: 'Inter', sans-serif;
